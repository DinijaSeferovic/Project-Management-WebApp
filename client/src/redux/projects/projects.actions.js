...
export const updateProjectAndRoles =
...
export const updateOneColumnTicketsOrder =
	(projectId, newColumn) => async (dispatch) => {
		try {
			dispatch({
...
export const updateTwoColumnsTicketsOrder =
	(projectId, newColumn) => async (dispatch) => {
		try {
			dispatch({
...
export const updateColumnOrder =
	(projectId, newColumnOrder) => async (dispatch) => {
		try {
			dispatch({
...
export const updateTicketStatus =
	(columnMove, ticketId, projectId) => async (dispatch) => {
...
export const updateColumnWithNewTicket =
	(projectId, ticketId, columnId) => async (dispatch) => {
